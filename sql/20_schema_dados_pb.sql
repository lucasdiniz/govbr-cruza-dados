...
CREATE TABLE pb_empenho (
    ...
    codigo_situacao_empenho         VARCHAR(10),
    codigo_tipo_empenho             VARCHAR(10),
    descricao_tipo_empenho          VARCHAR(100),
    nome_situacao_empenho           VARCHAR(100),
    valor_empenho                   DECIMAL(15,2),
    codigo_modalidade_licitacao     VARCHAR(10),
    codigo_motivo_dispensa_licitacao VARCHAR(10),
    codigo_tipo_credito             VARCHAR(10),
    nome_tipo_credito               VARCHAR(100),
    ...
    codigo_natureza_despesa         VARCHAR(20),
    codigo_categoria_economica_despesa VARCHAR(10),
    codigo_grupo_natureza_despesa   VARCHAR(10),
    codigo_modalidade_aplicacao_despesa VARCHAR(10),
    codigo_elemento_despesa         VARCHAR(10),
    codigo_item_despesa             VARCHAR(10),
    codigo_finalidade_fixacao       VARCHAR(10),
    nome_finalidade_fixacao         VARCHAR(100),
    codigo_licitacao                VARCHAR(30),
    orcamento_democratico           VARCHAR(10)
);
